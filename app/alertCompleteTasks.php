...
// get all complete tasks sorted by time when were created ,also check user ID
$sql = "SELECT ID, title, description, fileName, deadline, priority FROM tasks WHERE idOfUser = " . $_SESSION[ "ID" ] . " AND isComplete = 1 ORDER BY createdAt DESC ;";
...
if ( $result && $result->num_rows > 0 ) {
    ...
    while ( $row = mysqli_fetch_array( $result ) ) {
        ...
        <!-- task container -->
        <div class="task" style="background: <?= $row[ "priority" ] ?>; filter: grayscale(60%);">
            ...
            <div class="title-container">
                ...
                <ul class="expand-menu">
                    ...
                    >
                    <li class="complete"><img src="../assets/img/uncomplete.svg" alt="Complete Button"
                                              class="complete-btn">
                        <p>Uncomplete</p>
                    </li
                    >
